...
OriginPlot is a verification framework for editable Origin/OriginPro projects. It includes offline-contract-validated, AA2195-specific builders for Fig12, Fig15, and Fig16. It is not a universal system that converts any input image into a high-fidelity OPJU automatically.
...
|---|---|---|---|
| Fig12 | Specialized builder, schemas, direct XYZ Worksheet bindings, and offline regressions exist | Targeted optimization remains evidence-gated | Not a completed visual closure claim |
...
| Fig16 | Native GID399-style stacked-column structure and readback route exist | Visual completion remains provisional | Not final or complete |
...
The packaged AA2195 candidate files are parameter examples and intentionally do not redistribute paper source images. Supply an authorized local source path before a live benchmark run.
...
- Fig12 and Fig16 are not publicly claimed as visually complete.
