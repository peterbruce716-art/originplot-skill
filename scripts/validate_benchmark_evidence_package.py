...
def validate(path: Path) -> dict[str, Any]:
    ...
    return {"schema": "originplot.benchmark_evidence_package_check.v1", "protocol": "v5.8.9-p13_live_same_run", "path": path.name, "entry_count": len(entries), "status": "ok" if not failures else "failed", "failures": failures}
