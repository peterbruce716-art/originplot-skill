...
CRITICAL_SCRIPTS = [
    ...
    "scripts/originplot.py",
    "scripts/origin_profile_worker.py",
    "originplot/controller.py",
    "originplot/core/profiles.py",
    "originplot/core/figure_spec.py",
    "originplot/core/result.py",
    "originplot/template/policy.py",
    "originplot/runtime/protocol.py",
    "originplot/runtime/origin_session.py",
    "originplot/benchmarks/aa2195/config.py",
