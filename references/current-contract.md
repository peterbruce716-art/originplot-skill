...
- Fig3 legend swatches are also direct Worksheet-backed line plots. Their UC/TR gaps are encoded in editable NaN-separated columns, while panel labels, axes, legend text, and colored temperature annotations use the explicit Times New Roman typography profile.
